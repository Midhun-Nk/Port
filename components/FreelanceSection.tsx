...
const freelanceProjects = [
  {
    ...
    description: "A responsive and dynamic landing page for a travel company called fineway travels.Built in Next.js and tailwindcss with seo friendly.",
  ...
  },
  {
    client: "Mike Studio",
    project: "LearnStak",
    description: "A Educational Learning Platform for students and professionals.It include Roadmap  and Learning Path with all the documentaional resources.",
